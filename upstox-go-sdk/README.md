...
*ExpiredInstrumentApi* | [**GetExpiriesResponse**](docs/ExpiredInstrumentApi.md#getexpiriesresponse) | **Get** /v2/expired-instruments/expiries | Expired instruments - Get expiries
...
*MarketQuoteV3Api* | [**GetMarketQuoteOHLCV3**](docs/MarketQuoteV3Api.md#getmarketquoteohlcv3) | **Get** /v3/market-quote/ohlc | Market quotes and instruments - OHLC quotes
...
*OrderApi* | [**CancelGTTOrder**](docs/OrderApi.md#cancelgttorder) | **Delete** /v3/order/gtt/cancel | Cancel GTT order
*OrderApi* | [**CancelMultiOrder**](docs/OrderApi.md#cancelmultiorder) | **Delete** /v2/order/multi/cancel | Cancel multi order
*OrderApi* | [**CancelOrder**](docs/OrderApi.md#cancelorder) | **Delete** /v3/order/cancel | 
...
*OrderApi* | [**GetGttOrderDetails**](docs/OrderApi.md#getgttorderdetails) | **Get** /v3/order/gtt | Get GTT order details
...
*OrderApi* | [**ModifyGTTOrder**](docs/OrderApi.md#modifygttorder) | **Put** /v3/order/gtt/modify | Modify GTT order
*OrderApi* | [**ModifyOrder**](docs/OrderApi.md#modifyorder) | **Put** /v3/order/modify | 
*OrderApi* | [**ModifyOrder1**](docs/OrderApi.md#modifyorder1) | **Put** /v2/order/modify | Modify order
*OrderApi* | [**PlaceGTTOrder**](docs/OrderApi.md#placegttorder) | **Post** /v3/order/gtt/place | Place GTT order
*OrderApi* | [**PlaceMultiOrder**](docs/OrderApi.md#placemultiorder) | **Post** /v2/order/multi/place | Place multi order
*OrderApi* | [**PlaceOrder**](docs/OrderApi.md#placeorder) | **Post** /v3/order/place | 
