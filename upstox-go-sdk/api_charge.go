...
*/
func (a *ChargeApiService) GetBrokerage(ctx context.Context, instrumentToken Object, quantity Object, product Object, transactionType Object, price Object) (GetBrokerageResponse, *http.Response, error) {
	var (
