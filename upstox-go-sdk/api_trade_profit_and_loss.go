 ...
 * @param optional nil or *TradeProfitAndLossApiGetProfitAndLossChargesOpts - Optional Parameters:
     * @param "FromDate" (optional.Interface of Object) -  Date from which data needs to be fetched. from_date and to_date should fall under the same financial year as mentioned in financial_year attribute. Date in dd-mm-yyyy format
     * @param "ToDate" (optional.Interface of Object) -  Date till which data needs to be fetched. from_date and to_date should fall under the same financial year as mentioned in financial_year attribute. Date in dd-mm-yyyy format
...
func (a *TradeProfitAndLossApiService) GetProfitAndLossCharges(ctx context.Context, segment Object, financialYear Object, localVarOptionals *TradeProfitAndLossApiGetProfitAndLossChargesOpts) (GetProfitAndLossChargesResponse, *http.Response, error) {
	var (
...
func (a *TradeProfitAndLossApiService) GetTradeWiseProfitAndLossData(ctx context.Context, segment Object, financialYear Object, pageNumber Object, pageSize Object, localVarOptionals *TradeProfitAndLossApiGetTradeWiseProfitAndLossDataOpts) (GetTradeWiseProfitAndLossDataResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *TradeProfitAndLossApiService) GetTradeWiseProfitAndLossMetaData(ctx context.Context, segment Object, financialYear Object, localVarOptionals *TradeProfitAndLossApiGetTradeWiseProfitAndLossMetaDataOpts) (GetTradeWiseProfitAndLossMetaDataResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
