 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **instrumentToken** | [**Object**](.md)| Key of the instrument | 
  **quantity** | [**Object**](.md)| Quantity with which the order is to be placed | 
  **product** | [**Object**](.md)| Product with which the order is to be placed | 
  **transactionType** | [**Object**](.md)| Indicates whether its a BUY or SELL order | 
  **price** | [**Object**](.md)| Price with which the order is to be placed | 
