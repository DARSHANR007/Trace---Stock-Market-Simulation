 ...
 **state** | [**optional.Interface of Object**](.md)|  | 
 **scope** | [**optional.Interface of Object**](.md)|  | 
...
# **Token**
> TokenResponse Token(ctx, code, clientId, clientSecret, redirectUri, grantType)
Get token API
