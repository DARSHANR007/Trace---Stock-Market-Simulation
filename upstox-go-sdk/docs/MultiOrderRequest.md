...
**Slice** | [***Object**](.md) | To divide the order line based on predefined exchange definitions | [default to null]
...
**CorrelationId** | [***Object**](.md) | A unique identifier for tracking individual orders within the batch | [default to null]
