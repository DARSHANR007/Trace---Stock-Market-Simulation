...
------------- | ------------- | -------------
[**CancelGTTOrder**](OrderApi.md#CancelGTTOrder) | **Delete** /v3/order/gtt/cancel | Cancel GTT order
[**CancelMultiOrder**](OrderApi.md#CancelMultiOrder) | **Delete** /v2/order/multi/cancel | Cancel multi order
[**CancelOrder**](OrderApi.md#CancelOrder) | **Delete** /v3/order/cancel | 
...
[**GetGttOrderDetails**](OrderApi.md#GetGttOrderDetails) | **Get** /v3/order/gtt | Get GTT order details
...
[**ModifyGTTOrder**](OrderApi.md#ModifyGTTOrder) | **Put** /v3/order/gtt/modify | Modify GTT order
[**ModifyOrder**](OrderApi.md#ModifyOrder) | **Put** /v3/order/modify | 
[**ModifyOrder1**](OrderApi.md#ModifyOrder1) | **Put** /v2/order/modify | Modify order
[**PlaceGTTOrder**](OrderApi.md#PlaceGTTOrder) | **Post** /v3/order/gtt/place | Place GTT order
[**PlaceMultiOrder**](OrderApi.md#PlaceMultiOrder) | **Post** /v2/order/multi/place | Place multi order
[**PlaceOrder**](OrderApi.md#PlaceOrder) | **Post** /v3/order/place | 
[**PlaceOrder1**](OrderApi.md#PlaceOrder1) | **Post** /v2/order/place | Place order

# **CancelGTTOrder**
> GttTriggerOrderResponse CancelGTTOrder(ctx, body, optional)
Cancel GTT order
 ...
 **optional** | ***OrderApiCancelGTTOrderOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a OrderApiCancelGTTOrderOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **origin** | [**optional.Interface of Object**](.md)|  | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tag** | [**optional.Interface of Object**](.md)| The tag associated with the orders for which the orders must be cancelled | 
 **segment** | [**optional.Interface of Object**](.md)| The segment for which the orders must be cancelled | 
...
# **CancelOrder**
> CancelOrderV3Response CancelOrder(ctx, orderId)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **orderId** | [**Object**](.md)| The order ID for which the order must be cancelled | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tag** | [**optional.Interface of Object**](.md)| The tag associated with the positions for which the positions must be exit | 
 **segment** | [**optional.Interface of Object**](.md)| The segment for which the positions must be exit | 
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***OrderApiGetGttOrderDetailsOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a OrderApiGetGttOrderDetailsOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **gttOrderId** | [**optional.Interface of Object**](.md)| Unique identifier of the GTT order for which the order history is required | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **orderId** | [**optional.Interface of Object**](.md)| The order reference ID for which the order history is required | 
 **tag** | [**optional.Interface of Object**](.md)| The unique tag of the order for which the order history is being requested | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **orderId** | [**optional.Interface of Object**](.md)| The order reference ID for which the order details is required | 
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **orderId** | [**Object**](.md)| The order ID for which the order to get order trades | 
...
# **ModifyGTTOrder**
> GttTriggerOrderResponse ModifyGTTOrder(ctx, body, optional)
Modify GTT order
 ...
 **optional** | ***OrderApiModifyGTTOrderOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a OrderApiModifyGTTOrderOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **ModifyOrder**
> ModifyOrderV3Response ModifyOrder(ctx, body)
...
# **PlaceGTTOrder**
> GttTriggerOrderResponse PlaceGTTOrder(ctx, body, optional)
Place GTT order
 ...
 **optional** | ***OrderApiPlaceGTTOrderOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a OrderApiPlaceGTTOrderOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **PlaceMultiOrder**
> MultiOrderResponse PlaceMultiOrder(ctx, body, optional)
Place multi order
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **body** | [**Object**](.md)|  | 
 **optional** | ***OrderApiPlaceMultiOrderOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a OrderApiPlaceMultiOrderOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **PlaceOrder**
> PlaceOrderV3Response PlaceOrder(ctx, body)
